      ...
      items: [
        ...
        },
        {
          ...
          items: [
            ...
            'guides/rule-engine/rulegen-phase1-roslyn-foundation',
            'guides/rule-engine/rulegen-phase2-multifile-di-validation',
            'guides/rule-engine/rulegen-phase3-config-watch-tests',
            'guides/rule-engine/rulegen-phase4-merge-split-runtime',
            'guides/rule-engine/rulegen-phase5-enterprise-hardening',
